      ...
      <div className="contenedor">
        ...
        <div className="hijo">
             <p className="hijoText">Developer Front-End e Ingeniera Industrial, me caracterizo por tener iniciativa, ser proactiva, autodidacta, organizada, con alto sentido de responsabilidad, con capacidad de trabajar en equipo.<br/>
              En la actualidad decidí cambiar de rugro laboral y profesional, para convertirme en una desarrolladora web, realicé una bootcamp con la Fundación Laboratoria, desarrollé más de 6 proyectos reales y practicos en los que puse en practica Javascript, HTML, CSS, Node.Js, React, GitHub. 
              <br/>
